...
const TABLE_HEAD = ["Nama Mahasiswa", "Judul Proposal", "Status", "Tanggal", ""];
    ...
    <Card className="w-11/12 rounded-lg mt-10">
      <CardBody>
        ...
        <table className="w-full text-left mt-4">
          ...
          <tbody>
            {sortedRows.map(
              ({ img, name, email, job, org, online, date, time }, index) => {
